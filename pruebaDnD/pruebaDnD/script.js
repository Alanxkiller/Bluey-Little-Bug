...
function eventoEnter1(e) {
    console.log("soy el evento dragenter" + e.pageX - soltar1.offsetLeft +"posy " +e.pageY - soltar1.offsetTop)
    e.preventDefault();
...
function soltado1(e) {
    ...
    switch(id) {
      ...
      console.log("hola" + posx +"posy " + posy);
    lienzo1.drawImage(elemento, posx, posy);
}
...
function soltado4(e) {
    ...
    lienzo4.drawImage(elemento, posx, posy);
}
...
function soltado5(e) {
    ...
    lienzo5.drawImage(elemento, posx, posy);
}
...
function soltado6(e) {
    ...
    lienzo6.drawImage(elemento, posx, posy);
}
